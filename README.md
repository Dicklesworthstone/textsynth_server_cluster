...
You can see if the remote machines are listening on the correct port like this:
...
And you can check the `ts_server` log files on the remote machines easily like this:
